...
use ExpressionEngine\Dependency\Assert\Assertion;
use InvalidArgumentException;
use function ExpressionEngine\Dependency\Safe\parse_url;
use function ExpressionEngine\Dependency\Safe\sprintf;
use Throwable;
/**
