...
use ExpressionEngine\Dependency\Safe\Exceptions\LibeventException;
/**
...
{
    \error_clear_last();
    $result = \ExpressionEngine\Dependency\event_base_reinit($event_base);
    if ($result === \false) {
        throw LibeventException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \ExpressionEngine\Dependency\event_priority_set($event, $priority);
    if ($result === \false) {
        throw LibeventException::createFromPhpError();
    }
}
