...
use ExpressionEngine\Dependency\Safe\Exceptions\YazException;
/**
...
{
    \error_clear_last();
    $result = \ExpressionEngine\Dependency\yaz_ccl_parse($id, $query, $result);
    if ($result === \false) {
...
{
    \error_clear_last();
    $result = \ExpressionEngine\Dependency\yaz_close($id);
    if ($result === \false) {
        throw YazException::createFromPhpError();
    }
}
...
function yaz_connect(string $zurl, $options = null)
{
    \error_clear_last();
    if ($options !== null) {
        $result = \ExpressionEngine\Dependency\yaz_connect($zurl, $options);
    } else {
        $result = \ExpressionEngine\Dependency\yaz_connect($zurl);
    }
    if ($result === \false) {
        throw YazException::createFromPhpError();
    }
...
{
    \error_clear_last();
    $result = \ExpressionEngine\Dependency\yaz_database($id, $databases);
    if ($result === \false) {
        throw YazException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \ExpressionEngine\Dependency\yaz_element($id, $elementset);
    if ($result === \false) {
        throw YazException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \ExpressionEngine\Dependency\yaz_present($id);
    if ($result === \false) {
        throw YazException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \ExpressionEngine\Dependency\yaz_search($id, $type, $query);
    if ($result === \false) {
        throw YazException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \ExpressionEngine\Dependency\yaz_wait($options);
    if ($result === \false) {
        throw YazException::createFromPhpError();
    }
    return $result;
