...
use ExpressionEngine\Dependency\BaconQrCode\Encoder\MatrixUtil;
use ExpressionEngine\Dependency\BaconQrCode\Encoder\QrCode;
use ExpressionEngine\Dependency\BaconQrCode\Exception\InvalidArgumentException;
...
use ExpressionEngine\Dependency\BaconQrCode\Renderer\RendererStyle\EyeFill;
use ExpressionEngine\Dependency\BaconQrCode\Renderer\RendererStyle\Fill;
use GdImage;
final class GDLibRenderer implements RendererInterface
{
    ...
    private $fill;
    public function __construct(int $size, int $margin = 4, string $imageFormat = 'png', int $compressionQuality = 9, ?Fill $fill = null)
    {
