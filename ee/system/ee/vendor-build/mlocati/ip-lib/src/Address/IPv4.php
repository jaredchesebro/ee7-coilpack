...
namespace ExpressionEngine\Dependency\IPLib\Address;

use ExpressionEngine\Dependency\IPLib\ParseStringFlag;
use ExpressionEngine\Dependency\IPLib\Range\RangeInterface;
use ExpressionEngine\Dependency\IPLib\Range\Subnet;
use ExpressionEngine\Dependency\IPLib\Range\Type as RangeType;
/**
 * An IPv4 address.
 */
class IPv4 implements AddressInterface
{
     ...
     */
    public static function fromString($address, $mayIncludePort = \true, $supportNonDecimalIPv4 = \false)
    {
